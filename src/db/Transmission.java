...
public class Transmission {
    ...
    public Connection Connect() throws SQLException {
        ...
        try {
            ...
            //endereço do servidor /porta do servidor
            String url = "jdbc:mysql://localhost:3306/americans?createDatabaseIfNotExist=true&useUnicode=yes&characterEncoding=UTF-8";
            //usuário
            String usuario = "root";
